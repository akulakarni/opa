...
public class RegistrationFormValidatorImpl implements RegistrationFormValidator {
	...
	public static void validatePassword(String password, String confirmPassword, List<Error> errors) {
		List<Error> passwordValidationErrors = ValidationUtils.validatePassword(password);
