...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity httpSecurity) throws Exception {
		httpSecurity
			...
			.antMatchers("/opa-ui-rest-online-product-auction/user/forgot-password").permitAll()
			.antMatchers("/opa-ui-rest-online-product-auction/user/validate-password-reset-request").permitAll()
